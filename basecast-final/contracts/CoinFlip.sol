...
/// @title CoinFlip — BaseCast Provably Fair Coin Flip (Pyth Entropy v2)
/// @notice HEADS or TAILS. Win = 1.94× (3% house edge).
contract CoinFlip is BaseGame {
    ...
    // Pyth Provider — Base Sepolia:  0x39CC977C83a9b0AEf1C0f4e5a85c8CdA7fB2a9C
    // Pyth Provider — Base Mainnet:  0x52DeaA1c84233F7bb8C8A45baeDE41091c616506
    ...
    /// @param userRandom Client-side random bytes32 (keccak256 of any entropy)
    function placeBet(uint256 wager, Side choice, bytes32 userRandom)
    ...
    function _resolveGame(uint64 seqNum, bytes32 randomNumber) internal override {
        ...
        // Even byte = HEADS, Odd byte = TAILS
