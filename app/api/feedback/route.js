          ...
          <div style="padding:28px;">
            <table style="width:100%;border-collapse:collapse;">
              ...
              <tr>
                ...
                <td style="padding:10px 0;border-bottom:1px solid #1E2130;font-size:13px;color:#F0F2FF;">${subject}</td>
              </tr>
              ${wallet ? `<tr>
                <td style="padding:10px 0;border-bottom:1px solid #1E2130;font-size:12px;color:#6B7280;">Wallet</td>
                <td style="padding:10px 0;border-bottom:1px solid #1E2130;font-size:13px;color:#F0F2FF;font-family:monospace;">${wallet}</td>
              </tr>` : ""}
              ${contact ? `<tr>
                <td style="padding:10px 0;border-bottom:1px solid #1E2130;font-size:12px;color:#6B7280;">Contact</td>
                <td style="padding:10px 0;border-bottom:1px solid #1E2130;font-size:13px;color:#F0F2FF;">${contact}</td>
              </tr>` : ""}
            </table>
            <div style="margin-top:20px;">
              <div style="font-size:12px;color:#6B7280;margin-bottom:8px;">Message</div>
              <div style="background:#080B12;border:1px solid #1E2130;border-radius:8px;padding:16px;font-size:13px;color:#D1D5DB;line-height:1.7;white-space:pre-wrap;">${message}</div>
            </div>
          </div>
