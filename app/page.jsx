        ...
        {navSection==="home" && (
          <div className="fi" style={{display:"flex",flexDirection:"column",gap:16}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
              ...
              <div className="card" style={{display:"flex",flexDirection:"column",gap:10,alignItems:"flex-start",border:"1px solid var(--bd)",background:"rgba(255,255,255,0.04)",opacity:0.6}}>
