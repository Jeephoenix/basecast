...
:root{
  --bg:#08090D;--s1:#0E1017;--s2:#13151C;--bd:#1E2130;
...
.primary{background:var(--blue);color:#fff;padding:14px;width:100%;font-size:15px}
.primary:hover:not(:disabled){background:var(--blue2);transform:translateY(-1px)}
